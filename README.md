...
## Sobre Mim
- Tenho 20 anos e atualmente estou matriculada no Centro Universitário Senac - Santo Amaro.
- Cursando Análise e Desenvolvimento de Sistemas (5º semestre de 5).
- Estou aprendendo Java, HTML, CSS, JavaScript, React Native, MySQL e Angular no momento, mas pretendo expandir meus conhecimentos em linguagens de programação ainda esse ano.
